"""Company + competitor lookup via Groq (llama-3.3-70b-versatile)."""
from app.core.groq import getClient, parseJson


def getCompanyInfo(company_name: str, location: str, api_key: str | None = None):
    """Fetch a company profile plus competitors as structured JSON."""
